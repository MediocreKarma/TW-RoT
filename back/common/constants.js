...
export const ErrorCodes = Object.freeze({
    ...
    ANSWER_MISSING_BOOLEAN_PROPERTY: 44,
    ...
    QUESTION_ID_NOT_FOUND: 64,
    QUESTION_BODY_NOT_FOUND: 65,
    MISSING_CATEGORY_FROM_QUESTION: 66,
    INVALID_CATEGORY_ID: 67,
    MISSING_TEXT_FROM_QUESTION: 68,
    CATEGORY_ID_AND_CATEGORY_TITLE_GIVEN: 69,
    QUESTION_CATEGORY_NOT_FOUND: 70,
    CATEGORY_ALREADY_EXISTS: 71,
    ANSWER_MISSING_DESCRIPTION: 72,
    TOO_FEW_ANSWER_OPTIONS: 73,
    CATEGORY_TITLE_TOO_LONG: 74,
    DESCRIPTION_TOO_LONG: 75,
    INVALID_QUESTION_FORMAT: 76,
    USER_NOT_FOUND: 77,
    CHAPTER_TITLE_NOT_IN_BODY: 78,
    CHAPTER_TITLE_TOO_LONG: 79,
    CHAPTER_TITLE_TOO_SHORT: 80,
    CHAPTER_CONTENT_NOT_IN_BODY: 81,
    CHAPTER_CONTENT_TOO_SHORT: 82,
    CHAPTER_ADDENDUM_STATUS_NOT_IN_BODY: 83,
    CHAPTER_NUMBER_NOT_IN_BODY: 84,
    INVALID_CHAPTER_NUMBER: 85,
    INVALID_CHAPTER_ADDENDUM_STATUS: 86,
