import {getAllChaptersService, getChapterContentService} from "../services/chapterServices.js";
...
export async function getAllChapters(req, res) {
    ...
    sendJsonResponse(res, serviceResponse.status, JSON.stringify(serviceResponse.body), serviceResponse.message);
}
