...
export default function initOpenApi() {
    ...
    openapiSpecStr = openapiSpecStr.replace(
        /{CHAPTERS_PORT}/g,
        process.env.CHAPTERS_PORT
    );
    openapiSpecStr = openapiSpecStr.replace(
        /{TRAFFIC_SIGNS_PORT}/g,
        process.env.TRAFFIC_SIGNS_PORT
    );
    openapiSpecStr = openapiSpecStr.replace(
        /{EXERCISES_PORT}/g,
        process.env.EXERCISES_PORT
    );
    openapiSpecStr = openapiSpecStr.replace(
        /{USERS_PORT}/g,
    ...
    writeFileSync(`../../front/pages/swagger-ui/${filename}`, openapiSpecStr);
